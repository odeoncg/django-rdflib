...
from pyparsing import (Regex, Suppress, Combine, Optional, CaselessKeyword,
                       ZeroOrMore, OneOrMore, removeQuotes, quotedString, QuotedString,
...
String = (QuotedString(quoteChar='"""', escChar='\\', multiline=True) | quotedString).setParseAction(composition2(
  [stripQuotes, components.Expression.ParsedString]))
if DEBUG:
