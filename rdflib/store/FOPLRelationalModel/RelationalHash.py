...
#IDENTIFIER_GARBAGE_COLLECTION_SQL="CREATE TEMPORARY TABLE danglingIds AS SELECT %s.%s FROM %s %s where %s and %s.%s <> %s;"
IDENTIFIER_GARBAGE_COLLECTION_SQL="CREATE TEMPORARY TABLE danglingIds AS SELECT %s.%s FROM %s %s;"
VALUE_GARBAGE_COLLECTION_SQL="CREATE TEMPORARY TABLE danglingIds AS SELECT %s.%s FROM %s %s where %s"
#PURGE_KEY_SQL="DELETE %s FROM %s INNER JOIN danglingIds on danglingIds.%s = %s.%s;"
PURGE_KEY_SQL="DELETE FROM %s USING danglingIds WHERE danglingIds.%s = %s.%s;"
